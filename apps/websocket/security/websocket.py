...
from apps.websocket.generic.websocket import AsyncWebsocketConsumer
...
class OriginValidator:
    ...
    def validate_origin(self, parsed_origin):
        ...
        """
        return any(
            pattern == "*" or self.match_allowed_origin(parsed_origin, pattern) for pattern in self.allowed_origins
        )
