...
class TestBytesOrder:
    def test_endian_uchar_to_bytes(self):
        from xTool.cython.bytes_order import endian_uchar_to_bytes
    ...
    def test_endian_ushort_to_bytes(self):
        from xTool.cython.bytes_order import endian_ushort_to_bytes
    ...
    def test_endian_uint_to_bytes(self):
        from xTool.cython.bytes_order import endian_uint_to_bytes
    ...
    def test_endian_byte_to_uchar(self):
        from xTool.cython.bytes_order import endian_byte_to_uchar
    ...
    def test_endian_byte_to_ushort(self):
        from xTool.cython.bytes_order import endian_byte_to_ushort
    ...
    def test_endian_byte_to_uint(self):
        from xTool.cython.bytes_order import endian_byte_to_uint
