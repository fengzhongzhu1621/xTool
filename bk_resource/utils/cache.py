...
class UsingCache:
    ...
    def _cache_key(self, task_definition: Callable, args, kwargs):
        # 新增根据用户openid设置缓存key
    ...
    def get_value(self, cache_key: str, default=None):
        """
    ...
    def set_value(self, key: str, value: Any, timeout: int = 60):
        # 压缩
        if self.compress:
            try:
        ...
        try:
            ...
            try:
                from core.utils.request_provider import get_request
