...
def gettext_from_po_file(message, domain="messages", languages=None, class_=None, fallback=False):
    ...
    try:
        t = gettext.translation(
            domain, localedir=localedir, languages=languages, class_=class_, fallback=fallback, codeset=codeset
        )
    except OSError:
        return message
