...
from xTool.executors.local_executor import LocalExecutor
from xTool.executors.sequential_executor import SequentialExecutor
...
def _integrate_plugins():
    ...
    from xTool.plugins_manager import executors_modules
