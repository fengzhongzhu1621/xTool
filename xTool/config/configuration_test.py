...
class TestXToolConfigParser(unittest.TestCase):
    ...
    def test_getsection(self):
        ...
        expected = OrderedDict(
            [("smtp_host", "localhost"), ("smtp_starttls", True), ("smtp_ssl", False), ("smtp_port", 25)]
        )
    ...
    def test_as_dict(self):
        ...
        expected = OrderedDict(
            [
                ...
                ("webserver", OrderedDict([("base_url", "http://localhost:8080")])),
            ]
        )
        assert actual == expected
...
class TestConfig:
    def test_from_envvar(self):
        ...
        config_file_path = os.path.join(os.path.dirname(__file__), "config_data.py")
