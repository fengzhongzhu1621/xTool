...
_LegalChars = "{}{}{}".format(string.ascii_letters, string.digits, "!#$%&'*+-.^_`|~:")
_UnescapedChars = "{}{}".format(_LegalChars, " ()/<=>?@[]{}")
...
def _quote(str):
    r"""转义cookie的值，Quote a string for use in a cookie header.
    ...
    def __str__(self):
        ...
        for key, value in self.items():
            if key == "max-age":
                ...
                output.append("{}={}".format(self._keys[key], value.strftime("%a, %d-%b-%Y %T GMT")))
