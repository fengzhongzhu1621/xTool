...
import pygame as pg
from pygame._sdl2 import Image, Renderer, Texture, Window, get_drivers, messagebox
...
while running:
    for event in pg.event.get():
        if event.type == pg.QUIT:
            ...
            if event.type == pg.KEYDOWN and event.key == pg.K_ESCAPE or event.type == pg.WINDOWCLOSE:
                win2.destroy()
