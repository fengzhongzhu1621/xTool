...
class BinaryOperator(Operator, metaclass=ABCMeta):
    ...
    def render(self, obj_set):
        ...
        return "({} {} {})".format(attr, self.op, value)
    ...
    def expr(self):
        ...
        return "({} {} {})".format(self.field, self.op, value)
...
class EqualOperator(BinaryOperator):
    def __init__(self, field, value):
        super().__init__(OP.EQ, field, value)
...
class NotEqualOperator(BinaryOperator):
    def __init__(self, field, value):
        super().__init__(OP.NOT_EQ, field, value)
...
class InOperator(BinaryOperator):
    def __init__(self, field, value):
        ...
        super().__init__(OP.IN, field, value)
...
class NotInOperator(BinaryOperator):
    def __init__(self, field, value):
        # TODO: value should be list or string(sequence?)
        super().__init__(OP.NOT_IN, field, value)
...
class ContainsOperator(BinaryOperator):
    def __init__(self, field, value):
        super().__init__(OP.CONTAINS, field, value)
...
class NotContainsOperator(BinaryOperator):
    def __init__(self, field, value):
        super().__init__(OP.NOT_CONTAINS, field, value)
...
class StartsWithOperator(BinaryOperator):
    def __init__(self, field, value):
        ...
        super().__init__(OP.STARTS_WITH, field, value)
...
class NotStartsWithOperator(BinaryOperator):
    def __init__(self, field, value):
        # TODO: value should be string?
        super().__init__(OP.NOT_STARTS_WITH, field, value)
...
class EndsWithOperator(BinaryOperator):
    def __init__(self, field, value):
        # TODO: value should be string?
        super().__init__(OP.ENDS_WITH, field, value)
...
class NotEndsWithOperator(BinaryOperator):
    def __init__(self, field, value):
        # TODO: value should be string?
        super().__init__(OP.NOT_ENDS_WITH, field, value)
...
class LTOperator(BinaryOperator):
    def __init__(self, field, value):
        ...
        super().__init__(OP.LT, field, value)
...
class LTEOperator(BinaryOperator):
    def __init__(self, field, value):
        # TODO: field / value should be numberic
        super().__init__(OP.LTE, field, value)
...
class GTOperator(BinaryOperator):
    def __init__(self, field, value):
        # TODO: field / value should be numberic
        super().__init__(OP.GT, field, value)
...
class GTEOperator(BinaryOperator):
    def __init__(self, field, value):
        # TODO: field / value should be numberic
        super().__init__(OP.GTE, field, value)
...
class AnyOperator(BinaryOperator):
    def __init__(self, field, value):
        super().__init__(OP.ANY, field, value)
