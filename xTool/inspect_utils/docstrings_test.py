...
class DocstringsTest(unittest.TestCase):
    ...
    """
        ...
        expected_docstring_info = DocstringInfo(
            ...
            description='This is a longer description of the docstring. It spans ' 'multiple lines, as\nis allowed.',
            args=[
        ...
        expected_docstring_info = DocstringInfo(
            ...
            args=[
                ...
                ArgInfo(
                    name='param2',
                    type='str',
                    description='The second parameter. This has a lot of text, ' 'enough to cover two lines.',
                ),
            ],
        )
        self.assertEqual(expected_docstring_info, docstring_info)
    ...
    """
        ...
        expected_docstring_info = DocstringInfo(
            summary='Docstring summary.',
            description='This is a longer description of the docstring. It spans ' 'across multiple\nlines.',
            args=[
