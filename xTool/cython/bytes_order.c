...
static PyObject *__pyx_pw_5xTool_6cython_11bytes_order_1endian_uchar_to_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_i); /*proto*/
static PyObject *__pyx_f_5xTool_6cython_11bytes_order_endian_uchar_to_bytes(uint8_t __pyx_v_i, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("endian_uchar_to_bytes", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_5xTool_6cython_11bytes_order_1endian_uchar_to_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_i); /*proto*/
static PyObject *__pyx_pw_5xTool_6cython_11bytes_order_1endian_uchar_to_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_i) {
  uint8_t __pyx_v_i;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  assert(__pyx_arg_i); {
    __pyx_v_i = __Pyx_PyInt_As_uint8_t(__pyx_arg_i); if (unlikely((__pyx_v_i == ((uint8_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_5xTool_6cython_11bytes_order_endian_uchar_to_bytes(__pyx_self, ((uint8_t)__pyx_v_i));
...
static PyObject *__pyx_f_5xTool_6cython_11bytes_order_endian_ushort_to_bytes(uint16_t __pyx_v_i, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("endian_ushort_to_bytes", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_5xTool_6cython_11bytes_order_3endian_ushort_to_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_i); /*proto*/
static PyObject *__pyx_pw_5xTool_6cython_11bytes_order_3endian_ushort_to_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_i) {
  uint16_t __pyx_v_i;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  assert(__pyx_arg_i); {
    __pyx_v_i = __Pyx_PyInt_As_uint16_t(__pyx_arg_i); if (unlikely((__pyx_v_i == ((uint16_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("xTool.cython.bytes_order.endian_ushort_to_bytes", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5xTool_6cython_11bytes_order_2endian_ushort_to_bytes(__pyx_self, ((uint16_t)__pyx_v_i));
...
static PyObject *__pyx_pw_5xTool_6cython_11bytes_order_5endian_uint_to_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_i); /*proto*/
static PyObject *__pyx_f_5xTool_6cython_11bytes_order_endian_uint_to_bytes(uint32_t __pyx_v_i, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("endian_uint_to_bytes", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_5xTool_6cython_11bytes_order_5endian_uint_to_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_i); /*proto*/
static PyObject *__pyx_pw_5xTool_6cython_11bytes_order_5endian_uint_to_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_i) {
  uint32_t __pyx_v_i;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  assert(__pyx_arg_i); {
    __pyx_v_i = __Pyx_PyInt_As_uint32_t(__pyx_arg_i); if (unlikely((__pyx_v_i == ((uint32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("xTool.cython.bytes_order.endian_uint_to_bytes", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5xTool_6cython_11bytes_order_4endian_uint_to_bytes(__pyx_self, ((uint32_t)__pyx_v_i));
