...
def test_not_all_arguments_are_provided_issues_a_warning() -> None:
...
def test_repr() -> None:
    ...
    assert repr(pm.hook.myhook.get_hookimpls()[0]) == (f"<HookImpl plugin_name={pname!r}, plugin={plugin!r}>")
