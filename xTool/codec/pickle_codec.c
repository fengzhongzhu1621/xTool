...
static PyObject *__pyx_n_s_pyx_unpickle_PickleCodec;
 ...
 *         use_setstate = False             # <<<<<<<<<<<<<<
 *     if use_setstate:
 *         return __pyx_unpickle_PickleCodec, (type(self), 0xd41d8cd, None), state
 */
  /*else*/ {
 ...
 *         return __pyx_unpickle_PickleCodec, (type(self), 0xd41d8cd, None), state             # <<<<<<<<<<<<<<
 *     else:
 *         return __pyx_unpickle_PickleCodec, (type(self), 0xd41d8cd, state)
 */
    __Pyx_XDECREF(__pyx_r);
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_pyx_unpickle_PickleCodec); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_pyx_unpickle_PickleCodec); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_RefNannySetupContext("__pyx_unpickle_PickleCodec (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "__pyx_unpickle_PickleCodec") < 0)) __PYX_ERR(1, 1, __pyx_L3_error)
      }
...
static PyObject *__pyx_pf_5xTool_5codec_12pickle_codec___pyx_unpickle_PickleCodec(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v___pyx_type, long __pyx_v___pyx_checksum, PyObject *__pyx_v___pyx_state) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_unpickle_PickleCodec", 0);
...
static PyObject *__pyx_f_5xTool_5codec_12pickle_codec___pyx_unpickle_PickleCodec__set_state(struct __pyx_obj_5xTool_5codec_12pickle_codec_PickleCodec *__pyx_v___pyx_result, PyObject *__pyx_v___pyx_state) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_unpickle_PickleCodec__set_state", 0);
 ...
 */
  ...
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_stringsource, __pyx_n_s_pyx_unpickle_PickleCodec, 1, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
